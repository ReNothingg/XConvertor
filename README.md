...
-   **Работа с PDF**: Объединение, разделение, рендер страниц в JPG/PNG и распознавание текста (OCR).
...
| :--- | :--- | :--- |
| **Изображения** | `.jpg`, `.jpeg`, `.png`, `.bmp`, `.gif`, `.webp`, `.tiff` | `.jpg`, `.jpeg`, `.png`, `.bmp`, `.gif`, `.webp`, `.tiff`, `PDF (из изображений)`, `TXT (OCR)` |
| **Видео** | `.mp4`, `.avi`, `.mkv`, `.mov`, `.webm`, `.wmv` | `.mp4`, `.avi`, `.mkv`, `.mov`, `.webm`, `.wmv`, `GIF (анимация)`, `MP3/WAV/FLAC/AAC/OGG/M4A (аудио)` |
| **Аудио** | `.mp3`, `.wav`, `.flac`, `.aac`, `.ogg`, `.m4a` | `.mp3`, `.wav`, `.flac`, `.aac`, `.ogg`, `.m4a` |
| **Документы (PDF)** | `.pdf` | `.docx`, `.txt`, `.jpg`, `.png` |
| **Документы (Прочие)** | `.docx`, `.txt` | `.pdf`, `.txt` |
...
5.  Для пакетной конвертации появится отдельный диалог прогресса с возможностью остановки после текущего файла.
6.  Процесс и результат операции будут записаны во вкладке **"История"**.
...
-   **Работа с PDF**: PyPDF2, reportlab, pypdfium2
